...
function IframeUi() {
    ...
    this.vueData = {};
    this.vueMethod = {"focus":"function (e) {try {_t.fastKey.focusElem(e);}catch(e) {}}","_tabClick":"function(){setTimeout(function(){new McECharts().render();},200)}"};
...
IframeUi.prototype.api = function(){
    ...
    var api = {
        ...
        */
        ...
        resetAll:function(){
            _t.vueData = {};
            _t.vueMethod = {"focus":"function (e) {try {_t.fastKey.focusElem(e);}catch(e) {}}","_tabClick":"function(){setTimeout(function(){new McECharts().render();},200)}"};
            _t.vueMounted = 'function(){}';
        },
...
IframeUi.prototype.fixDynamicDomAfterRender = function(){
    var classNames = ["el-form-item__content","el-card__body"];
    ...
    var _t = this;
    $(".mc-open-dialog-btn").click(function(){
        setTimeout(function(){
            $(".el-dialog").each(function(idx,item){
